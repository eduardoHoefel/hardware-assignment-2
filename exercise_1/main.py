...
def load_rawfiles():
	...
	file_in = sio.loadmat('output_data.mat')
	file_traces = sio.loadmat('hardware_traces.mat')
	inp = file_in['output_data']
...
def merge_k(var_in):
	...
	var_in = [[x ^ np.uint8(k) for x in var_in] for k in range(256)]
...
def sboxlayer(v):
	print("calculating inv_s function")
	return [[inv_s(x) for x in y] for y in v]
...
if __name__ == '__main__':
	...
	m2 = [[x[i] for x in m] for i in range(len(m[0]))]
